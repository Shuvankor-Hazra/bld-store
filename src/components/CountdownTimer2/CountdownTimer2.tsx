...
const styles = "border font-semibold bg-black text-white text-[22px] w-[56px] h-[55px] flex items-center justify-center";
    ...
    return (
        <div className="text-white flex gap-3 justify-center items-center my-2">
            ...
            <div className="flex gap-2 flex-col items-center">
                ...
                <h3 className="text-[.8em]">Hours</h3>
            </div>
            <div className="flex gap-2 flex-col items-center">
                <h2 className={styles}>
                    {padWithZero(timeLeft.minutes)}
                </h2>
                <h3 className="text-[.8em]">Minute</h3>
            </div>
            <div className="flex gap-2 flex-col items-center">
                <h2 className={styles}>
                    {padWithZero(timeLeft.seconds)}
                </h2>
                <h3 className="text-[.8em]">Seconds</h3>
            </div>
        </div>
    );
};
