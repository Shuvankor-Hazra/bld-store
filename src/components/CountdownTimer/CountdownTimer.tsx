    ...
    return (
        <div className="text-white flex gap-3 justify-center items-center">
            <div className="flex flex-col items-center">
                <h2 className="border rounded-[7px] font-semibold bg-white text-black text-[19px] w-[30px] h-[30px] flex items-center justify-center relative">
                    {padWithZero(timeLeft.days)}
                </h2>
                <h3 className="text-[.8em] absolute bottom-0 tracking-tighter">Days</h3>
            </div>
            <div className="flex flex-col items-center">
                <h2 className="border rounded-[7px] font-semibold bg-white text-black text-[19px] w-[31px] h-[30px] flex items-center justify-center relative">
